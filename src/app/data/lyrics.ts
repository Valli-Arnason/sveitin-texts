...
export const lyricsData: Lyric[] = [

   {
    id: 'song1',
    title: 'Ó María mig langar heim',
    artist: 'Artist C',
    lyrics: ` Hann sigldi út um höfin blá í 17 ár
 ...
 og heillaði allstaðar stúlkurnar
 en meyjarnar aldrei í augun leit
 ...
 Ó, María hjá þér.`,
    ...
    {
    id: 'song2',
    title: 'Minning um mann',
    artist: 'Artist C',
    lyrics: ` Nú ætla ég að syngja ykkur lítið fallegt ljóð
...

 {
    ...
    artist: 'Artist C',
    lyrics: ` Hoppa kátur út um dyrnar
...

{
    ...
    artist: '',
    lyrics: `Undir bláhimni blíðsumars nætur
...
"Diggy liggy læla diggy, diggy liggy ló."

"Diggy liggy læla, diggy liggy ló"
...
"Diggy liggy læla, diggy liggy ló" osfr.`,
  },
...
Nóttin siglir að, minningin er kyrr
...
Það þýðir ei lengur að gefa þig upp
...
því að ég man að þú skrifaðir allt niður á blað
Nú ertu einmana
Af hverju einmana.
 
Þú sýndir mér margt sem að ég hef ei gleymt
Nú hlýtur einhver annar að vera með þér
Nú er ég einmana	
Af hverju einmana?
...
Það er erfitt að ná í mig
Já út í glugganum
Þú og ég með stjörnunum.
...
Man ég þá stund þegar þú varst mér hjá
Það var engin önnur kona nálægt mér þá
Nú er ég einmana
Af hverju einmana?
 
Þú sýndir mér margt sem að ég hef ei gleymt
Nú hlýtur meinhver annar að vera með þér
Nú er ég einmana 
Af hverju einmana?
...
Oh óuu,, Aldrei einn, aldrei einn
Því að stundum líður mér
Eins og þú sért jafnvel hjá mér
Aldrei einn
Þú og ég með stjörnunum.
